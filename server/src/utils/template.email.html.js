                ...
                <tr>
                  <td style="padding: 0 30px 20px">
                    <p style="margin-bottom: 10px">
                      Welcome! <br />
                      You are receiving this email because you have registered
                      daily weather alert on our site.
                    </p>
                    <p style="margin-bottom: 10px">
                      Click the link below to Confirm your email.
                    </p>
                    <p style="margin-bottom: 25px">
                      This link will expire in 5 minutes and can only be used
                      once.
                    </p>
                    <a
                      href="{{link_verify}}"
                ...
                <tr>
                  <td style="padding: 20px 30px 40px">
                    ...
                    >
                      ...
                      contact us at ddhuu.dev@gmail.com
                    </p>
                  </td>
                </tr>
              </tbody>
                ...
                <tr>
                  <td style="text-align: center; padding: 25px 20px 0">
                    <p style="font-size: 13px">
                      Copyright © 2024 Weather-Forecast. All rights reserved.
                      <br />
                      Template Made By
                      <a style="color: #6576ff; text-decoration: none" href=""
                        >ddhuu.dev</a
                      >.
                    </p>
